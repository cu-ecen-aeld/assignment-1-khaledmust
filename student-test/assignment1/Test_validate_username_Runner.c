...
int Test_validate_username_main(void)
{
  UnityBegin("/home/khaled/my-projects/linux-sys-prog-buildroot/assignment-1-khaledmust/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
